...
def test_indexes_exist(db_connection):
    ...
    expected_indexes = [
        ...
        "ix_jobs_posted_date",
        "ix_jobs_data_source_id",
        "ix_pipeline_runs_data_source_id",
        # Warehouse Indexes
        "idx_fact_jobs_company_id",
        "idx_fact_jobs_location_id",
        "idx_fact_jobs_date_id",
        "idx_fact_jobs_data_source_id",
        "idx_fact_jobs_pipeline_run_id",
        "idx_bridge_skill_id",
        "idx_fact_jobs_title_salary",
        "idx_dim_date_ymd",
        "idx_dim_location_remote",
        "idx_fact_jobs_active",
    ]
